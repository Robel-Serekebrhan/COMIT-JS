    ...
    <>
      <div className="click-speed-test-app">
        ...
        <div className="status-display">
          {gameStarted && <p className="timer">time left : {timeLeft}s</p>}
        ...
        {gameOver && (
          <div className="final-score">
            <h2>Game over!</h2>
            <p>
              your final score is : <strong>{finalScore.current} clicks</strong>
            </p>
            <button onClick={startGame} className="start-again-button">
              play again
            </button>
          </div>
        )}
